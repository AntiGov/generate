...
(function(c) {
    ...
    switch (a.substring(0, 2)) {
        case "es":
            b = {
                ...
                required_check: "Este campo es obligatorio.",
                add_address_number: "Por favor, indica el número de tu casa.",
        ...
        case "ru":
            b = {
                ...
                required_check: "Заполнить поле.",
                add_address_number: "Пожалуйста, добавьте ваш адрес.",
        ...
        case "fr":
            b = {
                ...
                required_check: "Ce champ est requis.",
                add_address_number: "Merci de bien vouloir indiquer le numéro de votre rue.",
        ...
        case "it":
            b = {
                ...
                required_check: "Questo campo é obbligatorio.",
                add_address_number: "Aggiungi il numero civico del tuo indirizzo.",
        ...
        case "de":
            b = {
                ...
                required_check: "Dieses Feld ist ein Pflichtfeld.",
                add_address_number: "Bitte tragen Sie Ihre Adresse ein.",
        ...
        case "cn":
            b = {
                required: "这是必填项",
                required_check: "这是必填项",
                add_address_number: "Please, add your building number.",
                remote: "这是必填项",
                email: "请输入有效邮箱地址。",
                url: "请输入有效网址。",
                date: "请输入有效日期。",
        ...
        default:
            b = {
                ...
                required_check: "This field is required.",
                add_address_number: "Please, add your building number.",
    ...
    c.extend(c.validator, {
        ...
        methods: {
            ...
            add_address_number: function(e, d) {
                return this.optional(d) || /\d+/g.test(e)
            },
...
ready_callbacks.push(function() {
    ...
    var a = resolution_steps();
    $(".background_howitworks_change").removeClass("background_howitworks_change").addClass("resolution" + a)
});
        ...
        default:
            switch (window.currency) {
                ...
                case "USD":
                    ...
                    if (window.region_url == "/en-ca/" || window.region_url == "/fr-ca/") {
                        c = c + '<small style="font-size: 50%">USD</small>'
                    }
                    break;
                case "GBP":
                    c = "<small>£</small>" + formatMoney(b, 2, ",", ".");
                ...
                case "MXN":
                    ...
                    break;
                case "CHF":
                    c = "<small>CHF </small>" + formatMoney(b, 2, "'", ".");
                    break;
                default:
